...
public class AddSawon extends JFrame {
    ...
    public AddSawon(String title) throws HeadlessException {
        super(title);
        this.setBounds(900, 100, 300, 350);
        this.getContentPane().setBackground(new Color(62, 144, 55));
        this.setDesign();

//        this.setVisible(true);
//        this.setDefaultCloseOperation(setDefaultCloseOperationJFrame.EXIT_ON_CLOSE);
    }
    ...
    public void setDesign() {
        ...
        txtName.setBounds(150, 20, 100, 30);
        this.add(txtName);

        String[] buseo = "교육부,홍보부,관리부".split(",");
        cbBuseo = new JComboBox<String>(buseo);
        cbBuseo.setBounds(150, 60, 100, 30);
        this.add(cbBuseo);
