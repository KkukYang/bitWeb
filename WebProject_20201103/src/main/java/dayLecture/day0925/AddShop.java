...
public class AddShop extends JFrame {
    ...
    public AddShop(String title) throws HeadlessException {
        super(title);
    ...
    private void setDesign() {
        ...
        btnAdd = new JButton("AddShop");
        btnAdd.setBounds(10, 10, 200, 30);
        this.add(btnAdd);
        ...
        btnPhoto.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                FileDialog dlg = new FileDialog(AddShop.this, "load photo", FileDialog.LOAD);
                dlg.setVisible(true);
